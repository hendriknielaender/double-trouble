...
weeds. Often at the same time, the bottom line, which is what comes out for the user, grows
slimmer and slimmer.
...
leaving as they're looking for better salaries or new challenges. The new maxime in engineering:
quality over everything. The product works.

Numbers go up and down. Mostly down, but its fine, we have to grow. At some point management will
make it clear that "growing is our status quo" - indicating that if we dont scale our business
together with the new employees, there will be a problem.
...
> Should engineers leave the engine room and come up to the navigation bridge?
...
obviously more extensible, and more maintainable. The customer will be happier and the company can
sell for higher prices.

When this maxime reaches engineering, it often puts even experienced engineers in a waking state
of sleep. From feverish bugfixing and hacking of the earliest days, engineering becomes a matter
of ideology.
...
A lot of teams plan for minor increases, for reworks, this, that and the other. While the revenue
is coming in, that might be fine. For a project that brings in revenue it is worth investing in
its quality.
...
This was a personal learning that our CEO felt strongly about and which he often shared with the
whole company.
...
## TODO move this whole next subsection on agile meetings in a different blog post on lean agile or something?
