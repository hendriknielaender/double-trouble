...
const pixelate = (value) => (value || value === 0 ? `${value}px` : undefined);
...
/* ** */
export const astroAsseetsOptimizer = async (image, breakpoints) => {
...
/* ** */
export const unpicOptimizer = async (image, breakpoints, width, height) => {
  if (!image || typeof image !== 'string') {
    return [];
  }
