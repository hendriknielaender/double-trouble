...
import { readingTimeRemarkPlugin, responsiveTablesRehypePlugin, lazyImagesRehypePlugin } from './src/utils/frontmatter.ts';
...
export default defineConfig({
  ...
  markdown: {
    ...
    rehypePlugins: [responsiveTablesRehypePlugin, lazyImagesRehypePlugin, rehypeSlug, [autolinkHeadings, autolinkConfig]],
  },
